...
#coding=utf-8
"""--------------------------------------------
#   Script is by Rizwan Ali
#	   Originally written by Rizwan_Ali
#		   Free Opensource Credit-Rizwan_Ali
#--------------------------------------------"""
...
{}
 Extract Tools By Rizwan Ali
 Version (7) | Free For All User
{}'''.format('\n',50*'-',50*'-')
...
def divider():
	...
	with open(filename, 'r',encoding='utf-8') as f:
		...
		for i in range(int(limit)):
			POP = i * DATEE
			POP2 = POP + DATEE
			with open("ra_{}_{}.txt".format(str(''.join(random.choices(string.ascii_letters.lower(), k=2))),i), 'w',encoding='utf-8') as out_file:
